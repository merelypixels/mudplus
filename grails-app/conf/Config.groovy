...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'mudplus.DriverUserDriverRole'
grails.plugin.springsecurity.authority.className = 'mudplus.DriverRole'
grails.plugin.springsecurity.requestMap.className = 'mudplus.DriverRequestMap'
grails.plugin.springsecurity.securityConfigType = 'Requestmap'
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	'/':                              ['permitAll'],
	'/index':                         ['permitAll'],
