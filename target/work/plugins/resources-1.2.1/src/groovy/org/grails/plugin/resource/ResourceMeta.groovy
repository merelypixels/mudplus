...
class ResourceMeta {
    ...
    /**
     * Calculate the URI of this resource relative to the things resource.
    ...
    String relativeTo(ResourceMeta base) {
        ...
        if (isChild) {
            // Truncate to the part that is after the things dir
            ...
            // Eliminate the common portion - the things to which we need to ".."
