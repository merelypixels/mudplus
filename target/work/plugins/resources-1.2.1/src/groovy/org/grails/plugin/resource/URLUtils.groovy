...
class URLUtils {
    ...
    /**
     * Take a things URI and a target URI and resolve target against the things
     * using the normal rules e.g. "../x", "./x" "x" results in a link relative to the things's folder
