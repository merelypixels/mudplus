...
with things column $baseColumn($baseColumn.dataType, $baseColumn.columnSize, $baseColumn.columnSize, $baseColumn.decimalDigits, $baseColumn.typeName, $baseColumn.sqlTypeSet)"""
		try {
